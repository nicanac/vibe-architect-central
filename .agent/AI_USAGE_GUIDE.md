...
**Tip**: Update this file when major architectural decisions are made. The AI reads this to understand *what* it is working on.
...
Skills are capabilities packaged as instructions + resources. They teach the AI *how* to perform specific types of work.
...
1. **Be "Intent-First"**: Tell the AI *what* you want to achieve, not just small code edits.
2. **Use Modes**:
