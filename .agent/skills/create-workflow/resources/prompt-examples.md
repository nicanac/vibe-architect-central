...
allowed-tools: [view_file, replace_file_content, write_to_file, run_command(npm :*)]
model: sonnet
---
```
...
<xml_format>
**Recommended for**: All workflows (better structure, Antigravity-native)
...
- Antigravity-native format (trained on XML)
- Easy to parse and validate
- Supports nested structure
  </xml_format>

<markdown_format>
**Use for**: Simple workflows, user preference, documentation focus
...
- Workflow is complex with multiple phases
- Need clear section boundaries
- Want Antigravity-optimized format
- Building reusable patterns

**Use Markdown when**:

- Workflow is simple (2-3 steps)
- User prefers markdown
- Documentation-focused
- Team unfamiliar with XML

**Default recommendation**: XML for consistency and Antigravity optimization
</when_to_use_each>
