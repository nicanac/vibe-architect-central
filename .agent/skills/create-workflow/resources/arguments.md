...
Official documentation examples for using arguments in workflows.
...
**Antigravity receives the full prompt** with "456" replacing #$ARGUMENTS.
...
### Use #$ARGUMENTS for Simple Workflows
...
Workflows work with or without arguments:
...
- Quote arguments containing spaces: `/workflow "argument with spaces"`
