...
| `description` | Yes | Natural language description of purpose. Include when Antigravity should invoke this. |
...
<invocation>
<automatic>
Antigravity automatically selects subagents based on:
