...
prev_step: resources/steps/step-01-interactive-prd.md
next_step: resources/steps/step-03-finish.md
---
...
```json
{
  ...
  "priority": 1,
  "passes": false,
  "notes": "Any context Antigravity needs"
}
```
...
✅ **Has Context** - Notes explain what Antigravity needs to know
...
After prd.json is saved, load `./resources/steps/step-03-finish.md` to show run instructions.
