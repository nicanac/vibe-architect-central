...
prev_step: null
next_step: resources/steps/step-01-interactive-prd.md
---
...
{ ralph_dir }: "{project_path}/.agent/ralph"
...
chmod +x .agent/skills/setup-ralph/scripts/setup.sh
.agent/skills/setup-ralph/scripts/setup.sh "{project_path}" "{feature_name}"
```

The setup script creates:

- `.agent/ralph/ralph.sh` (main loop)
- `.agent/ralph/prompt.md` (agent instructions)
- `.agent/ralph/tasks/{feature_name}/PRD.md` (empty template)
- `.agent/ralph/tasks/{feature_name}/prd.json` (empty stories)
- `.agent/ralph/tasks/{feature_name}/progress.txt` (learning log)
