...
This is a full-featured MEMORY.md example for a production SaaS application. Use as inspiration, adapting to your specific project.
...
- ~~`pnpm test`~~ - Interactive mode breaks Antigravity
- ~~`pnpm test:e2e`~~ - Interactive mode breaks Antigravity
