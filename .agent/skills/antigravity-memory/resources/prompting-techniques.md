...
Master guide for writing effective instructions in MEMORY.md files. These techniques ensure Antigravity follows your guidance reliably.

<core_principle>
Show your MEMORY.md to someone with minimal project context. If they're confused about what to do, Antigravity will be too.
</core_principle>
...
NEVER: Push directly to master or main branch
...
Structure your MEMORY.md with critical rules first:
...
<decision_criteria>
When Antigravity must make choices, provide criteria:
...
1. Did Antigravity follow the instructions?
2. Which instructions were ignored?
3. What did Antigravity do wrong?
...
| Problem | Solution |
|---------|----------|
| Antigravity ignores instruction | Add emphasis (CRITICAL, NEVER), move to top |
| Antigravity does wrong thing | Be more specific, add examples |
| Antigravity asks for clarification | Anticipate question, add answer |
...
<writing_checklist>
Before finalizing your MEMORY.md:
